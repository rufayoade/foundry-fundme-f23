...
import {DeployFundMe} from "../../src/DeployFundMe.s.sol"; 
...
contract FundMeTest is Test {
    ...
    function testOwnerIsMsgSender() public view {
     ...
     function testPriceFeedVersionIsAccurate() public view {
        ...
        if (version == 4) {
            // expected for some testnet or earlier feed
            assertEq(version, 4);
        } else {
            // fallback expected version, e.g. mainnet or newer feeds
            assertEq(version, 6);
        } 
    } 
    ...
    function testWithdrawWithASingleFunder() public funded {
        // Arrange
        // FIX APPLIED HERE: Changed getOwner() to i_owner()
